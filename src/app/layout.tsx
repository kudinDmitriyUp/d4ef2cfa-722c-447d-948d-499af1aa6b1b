...
export const metadata: Metadata = {
  title: "TechFund - Venture Capital for Italian Tech Innovation",
  description: "Invest in transformative technology companies. €250M+ AUM backing visionary founders building the future of European innovation.",
  keywords: "venture capital, VC Italy, tech investment, startup funding, European startups, SaaS, FinTech, AI investment",
  metadataBase: new URL("https://techfund.vc"),
  alternates: {
    canonical: "https://techfund.vc"
  },
  openGraph: {
    title: "TechFund - Venture Capital Investment",
    description: "Backing the next generation of transformative technology companies across Europe",
    siteName: "TechFund",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764123126584-oqxqayhh.jpg",
        alt: "TechFund - Venture Capital"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "TechFund - Venture Capital",
    description: "Investing in innovative tech companies across Europe",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764123126584-oqxqayhh.jpg"]
  },
  robots: {
    index: true,
    follow: true
